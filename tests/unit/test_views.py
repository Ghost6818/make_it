...
from make_it.controllers import GetUserController
...
def test_user_view_response_on_get_method(view: UserView) -> None:
    actual = view.get("2")
...
def test_users_controller_on_get_method(view: UserView, controller: Mock) -> None:
    view.get("1")
